 ...
 * @author    Tania <taniaao@hotmail.com>
 * @license   GPL-2.0+
...
class bussines_hours_widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'bussines_hours_widget';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			'bussines hours widget',
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => 'widget for business hours'
			)
		);
...
add_action( 'widgets_init', function(){
     register_widget( 'bussines_hours_widget' );
});
